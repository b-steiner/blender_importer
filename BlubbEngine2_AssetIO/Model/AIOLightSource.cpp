...
AIOLightSource::AIOLightSource(const std::string& name) : name(name), intensity(0), angle(0), angularAttenuation(0), color(0, 0, 0), attenuation(0, 0, 0),
...
inline const std::string & AssetIO::AIOLightSource::Name() const
{
	return name;
}
